...
<head>
  ...
  <!-- ลิงก์ไปยังไฟล์ CSS -->
  <link href="STmemberhomepage.css" rel="stylesheet">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light shadow">
    <div class="container-fluid">
      <!-- โลโก้และชื่อสนาม -->
      <a class="navbar-brand d-flex align-items-center" href="/web_badmintaon_khlong_6/Member/Member home page.php">
...
<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarMenu" aria-controls="navbarMenu" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse" id="navbarMenu">
        ...
        <!-- <a class="nav-link12 btn mx-1 custom-btn" href="/web_badmintaon_khlong_6/Member/Member home page.php">หน้าหลัก</a> -->

    <!-- เมนูด้านบนขวา บัญชี -->
    <div class="d-flex align-items-center">
    <a href="/web_badmintaon_khlong_6/Member/account edit.php" style="text-decoration: none; color: inherit;">

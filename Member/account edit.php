...
if (!isset($_SESSION['user_id'])) {
    echo "<script>alert('Session expired. Please login again.'); window.location.href = '../Member/account edit.php';</script>";
    exit();
}
...
<head>
  ...
  <!-- ลิงก์ไปยังไฟล์ CSS -->
  <link href="account edit.css" rel="stylesheet">
  <script>
...
<div class="container1 text-center">
  <div class="container d-flex align-items-center justify-content-center vh-100">
    <div class="card p-4 shadow custom-card" style="width: 60rem;">
      ...
      <!-- ฟอร์มแก้ไขบัญชีผู้ใช้งาน -->
      <form action="../php/editaccountmember.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        <!-- Profile Picture -->
        <div class="editimage">
...
<div class="custom-boxprevious">
  <a href="../Member/Member home page.php" class="btn-previous">ยกเลิก</a>
  ...
  function previewImage(event) {
    ...
    return;
        ...
        reader.onload = function(e) {
            ...
            imagePreview.style.display = 'block'; // แสดงตัวอย่างภาพ
        }

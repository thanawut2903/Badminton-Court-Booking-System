...
<head>
  ...
  <!-- ลิงก์ไปยังไฟล์ CSS -->
  <link href="Open group.css" rel="stylesheet">
  ...
  <div class="container mt-4">
    ...
    <div class="container d-flex justify-content-center align-items-center" style="height: 5vh;">
      <div class="custom-box text-center">
        <h1>การขอเปิดสนามแบบก๊วน</h1>
      </div>
    </div>
  </div>
  <div class="containerbooking mt-3 p-4 bg-light rounded shadow border" style="max-width: 750px; margin-left:700px;">
...
<script>
  ...
  <script src="/web_badmintaon_khlong_6/Member/opengroup.js"></script>
  <!-- Bootstrap JS -->

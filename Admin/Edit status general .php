...
<head>
  ...
  <!-- ลิงก์ไปยังไฟล์ CSS -->
  <link href="Edit status general .css" rel="stylesheet">
</head>
<body>
  ...
  <div class="container mt-4">
    ...
    <div class="container d-flex justify-content-center align-items-center" style="height: 5vh;">
      <div class="custom-box text-center">
        <h1>จัดการสถานะการจองแบบทั่วไป</h1>
      </div>
  </div>
...
$sql = "SELECT 
        ...
        WHERE b.BookingFormat = 'การจองแบบทั่วไป' 
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    echo '<td>' . $row['StartTime'] .' - '.$row['EndTime']. '</td>';
      ...
      if ($row['PaymentSlips']) {
        ...
        echo '<spna style="color:red">ยังไม่มีสลิปการโอนเงิน </span>';
    }
      echo '<td>';
